...
<body>
    ...
    <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 text-start mb-4 d-flex">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Mendapatkan sertifikat resmi sebagai bukti keikutsertaan dalam kegiatan
                                HIMA.
                            </p>
                        </div>
                    </div>
        ...
        <div class="container">
                        ...
                        <div class="activity-card mb-4">
                            <div class="activity-image ">
                                <img src="{{ asset('storage/' . $kegiatan->image) }}"
                                    alt="Activity {{ $kegiatan->id }}" class="w-100"
            ...
            <div class="mt-4 ">
                {{ $info_kegiatans->links('pagination::bootstrap-5') }}
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="footer-links">
                        <li><i class="fas fa-map-marker-alt me-2"></i> Ray V, Jl. Brigjen H. hasan Basri, Handil Bakti,
                            Kec. Alalak, Kabupaten Barito Kuala, Kalimantan Selatan 70582</li>
