<x-guest-layout>
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
                ...
                <div class="relative">
                    ...
                    <!-- Floating elements -->
                    <div class="absolute top-2 right-2 md:top-4 md:right-4 bg-white rounded-lg md:rounded-xl p-2 md:p-4 shadow-lg">
                    ...
                    <div class="absolute bottom-2 left-2 md:bottom-4 md:left-4 bg-white rounded-lg md:rounded-xl p-2 md:p-4 shadow-lg">
    ...
    <section id="hima" class="py-12 md:py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-12">
                <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 md:mb-0">HIMPUNAN MAHASISWA</h2>
                <a href="#" class="text-primary font-medium hover:underline text-sm md:text-base">Explore courses →</a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                @foreach ($himas as $hima)
                    <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                        <div class="relative">
                            <div class="h-32 md:h-48 bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center">
                                <div class="w-12 h-12 md:w-20 md:h-20 bg-white rounded-full flex items-center justify-center overflow-hidden">
                                    @if ($hima->image)
                            ...
                            <div class="absolute top-2 right-2 md:top-4 md:right-4 bg-primary text-white px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm font-medium">
                                BEST CHOICE
                            </div>
                        </div>
                        <div class="p-4 md:p-6">
                            <h3 class="text-lg md:text-xl font-bold mb-2">{{ $hima->nama }}</h3>
                            <p class="text-sm md:text-base text-gray-600 mb-4">Himpunan Mahasiswa Jurusan {{ $hima->user->name ?? 'Teknik' }}</p>
            ...
            <div class="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
                <div class="order-2 lg:order-1">
                    <img src="{{ asset('img/Politeknik_Hasnur.jpg') }}"
                        alt="Politeknik Hasnur" class="w-full rounded-2xl md:rounded-3xl shadow-2xl">
                </div>
                <div class="space-y-6 md:space-y-8 order-1 lg:order-2">
                    ...
                    <div class="space-y-4 md:space-y-6">
                        <div class="flex items-start space-x-3 md:space-x-4">
                            <div class="w-8 h-8 md:w-12 md:h-12 bg-primary rounded-full flex items-center justify-center flex-shrink-0">
                            ...
                            <div>
                                ...
                                <p class="text-sm md:text-base text-gray-600">Membangun relasi profesional dengan mahasiswa dan alumni dari
                        ...
                        <div class="flex items-start space-x-3 md:space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm md:text-base text-gray-600">Mengembangkan kemampuan kepemimpinan dan kerja sama tim dalam
                        ...
                        <div class="flex items-start space-x-3 md:space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm md:text-base text-gray-600">Mendapatkan sertifikat resmi sebagai bukti keikutsertaan dalam
                                    kegiatan HIMA.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3 md:space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm md:text-base text-gray-600">Meningkatkan keterampilan public speaking, manajemen waktu,
    ...
    <section id="kegiatan" class="py-12 md:py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-2 md:mb-4">KEGIATAN HIMA</h2>
            <p class="text-base md:text-lg lg:text-xl text-gray-600 text-center mb-8 md:mb-12">Berbagai kegiatan menarik untuk mengembangkan potensi mahasiswa</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                @foreach ($info_kegiatans as $kegiatan)
                    <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all hover:-translate-y-2 mb-4 md:mb-6">
                        <div class="h-32 md:h-48 bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center">
                            @if ($kegiatan->image)
                        ...
                        <div class="p-4 md:p-6">
                            <span class="bg-orange-100 text-orange-600 px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm font-medium mb-2 inline-block">
                                {{ $kegiatan->nama }}
                            </span>
                            <h3 class="text-lg md:text-xl font-bold mt-2 mb-2">{{ $kegiatan->nama }}</h3>
                            <p class="text-sm md:text-base text-gray-600 mb-4">{{ Str::limit($kegiatan->keterangan, 100) }}</p>
            ...
            <div class="p-4 md:p-6">
                ...
                <div class="mb-4 md:mb-6">
                    <img id="modalImage" src="" alt="Activity Image"
                        class="w-full h-32 md:h-50 object-cover rounded-lg">
                </div>
