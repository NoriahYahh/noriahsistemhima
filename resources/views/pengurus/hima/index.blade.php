                                ...
                                <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 h-full">
                                    ...
                                    @if($hima->image)
                                        <div class="relative group">
                                            ...
                                            <div class="absolute inset-0 bg-blue-600 bg-opacity-0 group-hover:bg-opacity-10 rounded-xl transition-all duration-300"></div>
                                        </div>
                                    @else
                            ...
                            <div class="lg:col-span-2">
                                <div class="space-y-6">
                                    ...
                                    <div class="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-6 border-l-4 border-blue-500">
                                        <h3 class="text-xl font-bold text-gray-800 mb-3 flex items-center">
                                            <svg class="w-6 h-6 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v6a2 2 0 002 2h2m0 0V9a2 2 0 012-2h2a2 2 0 012 2v6a2 2 0 01-2 2H9m0 0v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2h2m0 0V5a2 2 0 012-2h2"></path>
                                            </svg>
                                            Misi
                                        </h3>
                                        <div class="bg-white rounded-lg p-4 shadow-sm">
            ...
            @else
                ...
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                    <div class="text-center py-16 px-8">
                        <div class="mx-auto w-32 h-32 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full flex items-center justify-center mb-8">
