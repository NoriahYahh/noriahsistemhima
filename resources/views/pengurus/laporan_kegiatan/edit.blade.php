                ...
                <div class="p-8 text-gray-900">
                    ...
                    @if($laporanKegiatan->status === 'Terverifikasi')
                        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-6">
                            <strong>Status:</strong> Laporan ini sudah terverifikasi dan tidak dapat diedit.
                        </div>
                    @elseif($laporanKegiatan->status === 'Ditolak')
                        <div class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded relative mb-6">
                            <strong>Status:</strong> Laporan ini ditolak. Silakan edit dan kirim ulang untuk verifikasi.
                        </div>
                    @else
                        <div class="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded relative mb-6">
                            <strong>Status:</strong> Laporan ini sedang menunggu verifikasi. Setelah diedit, status akan kembali ke menunggu verifikasi.
                        </div>
                    @endif
                    ...
                    <form action="{{ route('laporan_kegiatan.update', $laporanKegiatan) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" name="name" 
                                           value="{{ old('name', $laporanKegiatan->name) }}"
                                ...
                                <div>
                                    ...
                                    <input type="date" name="tanggal" 
                                           value="{{ old('tanggal', $laporanKegiatan->tanggal) }}"
                                ...
                                <div>
                                    ...
                                    <textarea name="keterangan" rows="4" 
                                              class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" 
                                              placeholder="Masukkan keterangan kegiatan..." required>{{ old('keterangan', $laporanKegiatan->keterangan) }}</textarea>
                                </div>

                                <div>
                                    <label class="block mb-2 text-sm font-medium text-gray-700">
                                        Gambar Kegiatan <span class="text-gray-500">(Kosongkan jika tidak ingin mengubah)</span>
                                    </label>
                                    ...
                                    @if($laporanKegiatan->image)
                                        <div class="mt-2">
                                            <p class="text-sm text-green-600">Gambar saat ini:</p>
                                            <img src="{{ Storage::url($laporanKegiatan->image) }}" 
                                                 alt="Gambar saat ini" 
                                                 class="w-32 h-32 object-cover rounded-md border mt-1">
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div>
                                    <label class="block mb-2 text-sm font-medium text-gray-700">
                                        Video Kegiatan <span class="text-gray-500">(Opsional - Kosongkan jika tidak ingin mengubah)</span>
                                    </label>
                                    ...
                                    @if($laporanKegiatan->video)
                                        <div class="mt-2">
                                            <p class="text-sm text-green-600">Video saat ini:</p>
                                            <video controls class="w-64 h-40 rounded-md border mt-1">
                                                <source src="{{ Storage::url($laporanKegiatan->video) }}" type="video/mp4">
                            ...
                            <div class="space-y-6">
                                <!-- Preview Gambar -->
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-700 mb-3">Preview Gambar Baru</h3>
                                    ...
                                    <div id="image-placeholder" class="block">
                                        <div class="border border-gray-300 rounded-lg p-4 bg-gray-50">
                                            @if($laporanKegiatan->image)
                                                ...
                                                <p class="text-sm text-blue-600 mt-2 text-center font-medium">
                                ...
                                <!-- Preview Video -->
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-700 mb-3">Preview Video Baru</h3>
                                    ...
                                    <div id="video-placeholder" class="block">
                                        <div class="border border-gray-300 rounded-lg p-4 bg-gray-50">
                                            @if($laporanKegiatan->video)
                                                ...
                                                <p class="text-sm text-blue-600 mt-2 text-center font-medium">
                                                    🎥 Video saat ini (pilih file baru untuk mengubah)
                                                </p>
                                            @else
                                                <div class="w-full h-64 bg-gray-200 rounded-lg flex items-center justify-center">
                                                    <div class="text-center">
