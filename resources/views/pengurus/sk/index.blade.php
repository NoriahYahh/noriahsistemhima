                        ...
                        <table class="w-full table-auto">
                            <thead class="bg-gray-400 text-gray-700">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-sm font-semibold uppercase tracking-wider">File</th>
                                ...
                                <tr class="border-t border-gray-200">
                                    ...
                                    <td class="px-6 py-4 text-sm">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('sk.show', $sk) }}" target="_blank" class="inline-flex items-center px-3 py-1 bg-green-500 hover:bg-green-600 text-white text-xs font-medium rounded-md transition duration-200">
                                            ...
                                            <a href="{{ route('sk.download', $sk) }}" class="inline-flex items-center px-3 py-1 bg-blue-500 hover:bg-blue-600 text-white text-xs font-medium rounded-md transition duration-200">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <td class="px-6 py-4 text-sm flex space-x-4">
                                        <a href="{{ route('sk.edit', $sk) }}" class="text-blue-600 hover:text-blue-800 font-medium">Edit</a>
                                        <form action="{{ route('sk.destroy', $sk) }}" method="POST" class="inline-block">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-red-600 hover:text-red-800 font-medium" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</button>
                                        </form>
                                    </td>
                                </tr>
                                @empty
                                <tr class="border-t border-gray-200">
                                    <td colspan="3" class="px-6 py-4 text-sm text-center text-gray-500">Belum ada data SK</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
