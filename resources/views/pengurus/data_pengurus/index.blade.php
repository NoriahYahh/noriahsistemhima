        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg border border-gray-100">
                <div class="p-8 text-gray-900">
                    ...
                    <form action="{{ route('data_pengurus.store') }}" method="POST" enctype="multipart/form-data" class="mb-10 space-y-6">
                        @csrf
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full table-auto">
                            ...
                            <tbody class="bg-gray-100">
                                @forelse ($pengurus as $p)
                                    <tr class="border-t border-gray-200">
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            @if ($p->image)
                                                <img src="{{ Storage::url($p->image) }}" class="w-16 h-16 object-cover rounded-md" alt="{{ $p->name }}">
                                            @else
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <div class="flex space-x-4">
                                                ...
                                                <form action="{{ route('data_pengurus.destroy', $p->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-4 text-sm text-center text-gray-500">Tidak ada data pengurus</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
